        ...
        leads.forEach(lead => {
            ...
            tr.innerHTML = `
                ...
                <td class="lead-actions-cell">
                    <button class="lead-action-btn btn-edit" data-tooltip="Editar" onclick="editLeadModal('${lead.id}')">✏️</button>
                    <button class="lead-action-btn btn-delete action-delete" data-tooltip="Borrar" onclick="deleteLead('${lead.id}')">🗑️</button>
                    <button class="lead-action-btn btn-email" data-tooltip="Enviar Email" onclick="quickEmailLead('${lead.email}', '${lead.first_name || ''}')">📧</button>
                    <button class="lead-action-btn btn-whatsapp" data-tooltip="WhatsApp" onclick="openWhatsApp('${lead.email}', '${lead.first_name || ''}', '${lead.company_name || ''}')">💬</button>
                    <button class="lead-action-btn btn-signup" data-tooltip="Formulario de alta" onclick="sendSignupForm('${lead.email}', '${lead.first_name || ''}')">📋</button>
                </td>
            `;
